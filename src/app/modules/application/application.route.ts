...
router.patch("/interview-change-time/:id",auth(USER_ROLES.RECRUITER, USER_ROLES.EMPLOYEE),validateRequest(ApplicationValidations.changeInterviewDetailsZodSchema),ApplicationController.changeTimedateOfIterview)
